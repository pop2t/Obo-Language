...
fn main() {
    let mut bodies = [
        ...
        Body { x: 12.894369562139131, y: -15.1111514016986312, z: -0.223307578892655734,
               vx: 0.00296460137564761618 * DAYS_PER_YEAR, vy: 0.0023784717395948095 * DAYS_PER_YEAR, vz: -0.0000296589568540237556 * DAYS_PER_YEAR,
