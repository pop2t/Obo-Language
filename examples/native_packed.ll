...
@obo.str.0 = private unnamed_addr constant [21 x i8] c"packed structs work!\00"
@obo.str.1 = private unnamed_addr constant [10 x i8] c"TCPHeader\00"
@obo.str.2 = private unnamed_addr constant [9 x i8] c"src_port\00"
@obo.str.3 = private unnamed_addr constant [9 x i8] c"dst_port\00"
@obo.str.4 = private unnamed_addr constant [8 x i8] c"seq_num\00"
@obo.str.5 = private unnamed_addr constant [6 x i8] c"Pixel\00"
@obo.str.6 = private unnamed_addr constant [2 x i8] c"r\00"
@obo.str.7 = private unnamed_addr constant [2 x i8] c"g\00"
@obo.str.8 = private unnamed_addr constant [2 x i8] c"b\00"
@obo.str.9 = private unnamed_addr constant [2 x i8] c"a\00"
...
entry:
  ...
  call void @obo_gc_push_root(i8** %var_px_ptr)
  %t0 = call i8* @malloc(i64 8)
  %t1 = bitcast i8* %t0 to <{ i16, i16, i32 }>*
  %t2 = trunc i64 8080 to i16
  %t3 = getelementptr inbounds <{ i16, i16, i32 }>, <{ i16, i16, i32 }>* %t1, i32 0, i32 0
  store i16 %t2, i16* %t3
  %t4 = trunc i64 443 to i16
  %t5 = getelementptr inbounds <{ i16, i16, i32 }>, <{ i16, i16, i32 }>* %t1, i32 0, i32 1
  store i16 %t4, i16* %t5
  %t6 = trunc i64 12345 to i32
  %t7 = getelementptr inbounds <{ i16, i16, i32 }>, <{ i16, i16, i32 }>* %t1, i32 0, i32 2
  store i32 %t6, i32* %t7
  store i8* %t0, i8** %reg_0_ptr
  %t8 = load i8*, i8** %reg_0_ptr
  store i8* %t8, i8** %var_header_ptr
  %t9 = load i8*, i8** %var_header_ptr
  store i8* %t9, i8** %reg_1_ptr
  %t10 = load i8*, i8** %reg_1_ptr
  %t11 = bitcast i8* %t10 to <{ i16, i16, i32 }>*
  %t12 = getelementptr inbounds <{ i16, i16, i32 }>, <{ i16, i16, i32 }>* %t11, i32 0, i32 0
  %t13 = load i16, i16* %t12
  %t14 = sext i16 %t13 to i64
  store i64 %t14, i64* %reg_2_ptr
  %t15 = load i8*, i8** %reg_2_ptr
  call void @obo_value_print(i8* %t15)
  %t16 = load i8*, i8** %var_header_ptr
  store i8* %t16, i8** %reg_3_ptr
  %t17 = load i8*, i8** %reg_3_ptr
  %t18 = bitcast i8* %t17 to <{ i16, i16, i32 }>*
  %t19 = getelementptr inbounds <{ i16, i16, i32 }>, <{ i16, i16, i32 }>* %t18, i32 0, i32 1
  %t20 = load i16, i16* %t19
  %t21 = sext i16 %t20 to i64
  store i64 %t21, i64* %reg_4_ptr
  %t22 = load i8*, i8** %reg_4_ptr
  call void @obo_value_print(i8* %t22)
  %t23 = load i8*, i8** %var_header_ptr
  store i8* %t23, i8** %reg_5_ptr
  %t24 = load i8*, i8** %reg_5_ptr
  %t25 = bitcast i8* %t24 to <{ i16, i16, i32 }>*
  %t26 = getelementptr inbounds <{ i16, i16, i32 }>, <{ i16, i16, i32 }>* %t25, i32 0, i32 2
  %t27 = load i32, i32* %t26
  %t28 = sext i32 %t27 to i64
  store i64 %t28, i64* %reg_6_ptr
  %t29 = load i8*, i8** %reg_6_ptr
  call void @obo_value_print(i8* %t29)
  %t30 = call i8* @malloc(i64 4)
  %t31 = bitcast i8* %t30 to <{ i8, i8, i8, i8 }>*
  %t32 = trunc i64 255 to i8
  %t33 = getelementptr inbounds <{ i8, i8, i8, i8 }>, <{ i8, i8, i8, i8 }>* %t31, i32 0, i32 0
  store i8 %t32, i8* %t33
  %t34 = trunc i64 128 to i8
  %t35 = getelementptr inbounds <{ i8, i8, i8, i8 }>, <{ i8, i8, i8, i8 }>* %t31, i32 0, i32 1
  store i8 %t34, i8* %t35
  %t36 = trunc i64 0 to i8
  %t37 = getelementptr inbounds <{ i8, i8, i8, i8 }>, <{ i8, i8, i8, i8 }>* %t31, i32 0, i32 2
  store i8 %t36, i8* %t37
  %t38 = trunc i64 255 to i8
  %t39 = getelementptr inbounds <{ i8, i8, i8, i8 }>, <{ i8, i8, i8, i8 }>* %t31, i32 0, i32 3
  store i8 %t38, i8* %t39
  store i8* %t30, i8** %reg_7_ptr
  %t40 = load i8*, i8** %reg_7_ptr
  store i8* %t40, i8** %var_px_ptr
  %t41 = load i8*, i8** %var_px_ptr
  store i8* %t41, i8** %reg_8_ptr
  %t42 = load i8*, i8** %reg_8_ptr
  %t43 = bitcast i8* %t42 to <{ i8, i8, i8, i8 }>*
  %t44 = getelementptr inbounds <{ i8, i8, i8, i8 }>, <{ i8, i8, i8, i8 }>* %t43, i32 0, i32 0
  %t45 = load i8, i8* %t44
  %t46 = sext i8 %t45 to i64
  store i64 %t46, i64* %reg_9_ptr
  %t47 = load i8*, i8** %reg_9_ptr
  call void @obo_value_print(i8* %t47)
  %t48 = load i8*, i8** %var_px_ptr
  store i8* %t48, i8** %reg_10_ptr
  %t49 = load i8*, i8** %reg_10_ptr
  %t50 = bitcast i8* %t49 to <{ i8, i8, i8, i8 }>*
  %t51 = getelementptr inbounds <{ i8, i8, i8, i8 }>, <{ i8, i8, i8, i8 }>* %t50, i32 0, i32 1
  %t52 = load i8, i8* %t51
  %t53 = sext i8 %t52 to i64
  store i64 %t53, i64* %reg_11_ptr
  %t54 = load i8*, i8** %reg_11_ptr
  call void @obo_value_print(i8* %t54)
  %t55 = load i8*, i8** %var_px_ptr
  store i8* %t55, i8** %reg_12_ptr
  %t56 = load i8*, i8** %reg_12_ptr
  %t57 = bitcast i8* %t56 to <{ i8, i8, i8, i8 }>*
  %t58 = getelementptr inbounds <{ i8, i8, i8, i8 }>, <{ i8, i8, i8, i8 }>* %t57, i32 0, i32 2
  %t59 = load i8, i8* %t58
  %t60 = sext i8 %t59 to i64
  store i64 %t60, i64* %reg_13_ptr
  %t61 = load i8*, i8** %reg_13_ptr
  call void @obo_value_print(i8* %t61)
  %t62 = load i8*, i8** %var_px_ptr
  store i8* %t62, i8** %reg_14_ptr
  %t63 = load i8*, i8** %reg_14_ptr
  %t64 = bitcast i8* %t63 to <{ i8, i8, i8, i8 }>*
  %t65 = getelementptr inbounds <{ i8, i8, i8, i8 }>, <{ i8, i8, i8, i8 }>* %t64, i32 0, i32 3
  %t66 = load i8, i8* %t65
  %t67 = sext i8 %t66 to i64
  store i64 %t67, i64* %reg_15_ptr
  %t68 = load i8*, i8** %reg_15_ptr
  call void @obo_value_print(i8* %t68)
  %t69 = load i8*, i8** %var_header_ptr
  store i8* %t69, i8** %reg_16_ptr
  %t70 = load i8*, i8** %reg_16_ptr
  %t71 = bitcast i8* %t70 to <{ i16, i16, i32 }>*
  %t72 = getelementptr inbounds <{ i16, i16, i32 }>, <{ i16, i16, i32 }>* %t71, i32 0, i32 1
  %t73 = trunc i64 8443 to i16
  store i16 %t73, i16* %t72
  %t74 = load i8*, i8** %var_header_ptr
  store i8* %t74, i8** %reg_17_ptr
  %t75 = load i8*, i8** %reg_17_ptr
  %t76 = bitcast i8* %t75 to <{ i16, i16, i32 }>*
  %t77 = getelementptr inbounds <{ i16, i16, i32 }>, <{ i16, i16, i32 }>* %t76, i32 0, i32 1
  %t78 = load i16, i16* %t77
  %t79 = sext i16 %t78 to i64
  store i64 %t79, i64* %reg_18_ptr
  %t80 = load i8*, i8** %reg_18_ptr
  call void @obo_value_print(i8* %t80)
  call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @obo.fmt.str, i64 0, i64 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @obo.str.0, i64 0, i64 0))
