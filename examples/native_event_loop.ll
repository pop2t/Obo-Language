...
@obo.str.0 = private unnamed_addr constant [9 x i8] c"stopping\00"
@obo.str.1 = private unnamed_addr constant [43 x i8] c"Starting event loop (5 frames at 30fps)...\00"
@obo.str.2 = private unnamed_addr constant [21 x i8] c"Event loop finished!\00"

define void @on_frame(i8* %arg0) {
entry:
  ...
  %var_frame_ptr = alloca i64
  %arg0_ptoi = ptrtoint i8* %arg0 to i64
  store i64 %arg0_ptoi, i64* %reg_0_ptr
  ...
  %t4 = call i64 @obo_atomic_add(i8* %t3, i64 1)
  store i64 %t4, i64* %reg_2_ptr
  %t5 = load i64, i64* %reg_2_ptr
  store i64 %t5, i64* %var_frame_ptr
  %t6 = load i64, i64* %var_frame_ptr
  store i64 %t6, i64* %reg_3_ptr
  %t7 = load i64, i64* %reg_3_ptr
  call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @obo.fmt.i64, i64 0, i64 0), i64 %t7)
  %t8 = load i64, i64* %var_frame_ptr
  store i64 %t8, i64* %reg_4_ptr
  %t9 = load i64, i64* %reg_4_ptr
  %t10 = icmp sge i64 %t9, 5
  ...
  br i1 %t13, label %on_frame_b1, label %on_frame_b2
on_frame_b1:
  call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @obo.fmt.str, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @obo.str.0, i64 0, i64 0))
  call void @obo_event_loop_stop()
  store i64 0, i64* %reg_6_ptr
  br label %on_frame_b3
on_frame_b2:
  br label %on_frame_b3
on_frame_b3:
  ret void
...
entry:
  ...
  %reg_2_ptr = alloca i8*
  %reg_3_ptr = alloca i64
  %var_counter_ptr = alloca i8*
  %var_on_frame_ptr = alloca i64
  call void @obo_gc_push_root(i8** %reg_0_ptr)
  call void @obo_gc_push_root(i8** %reg_2_ptr)
  call void @obo_gc_push_root(i8** %var_counter_ptr)
  call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @obo.fmt.str, i64 0, i64 0), i8* getelementptr inbounds ([43 x i8], [43 x i8]* @obo.str.1, i64 0, i64 0))
  %t0 = call i8* @obo_atomic_create(i64 0)
  store i8* %t0, i8** %reg_0_ptr
  %t1 = load i8*, i8** %reg_0_ptr
  store i8* %t1, i8** %var_counter_ptr
  %t2 = ptrtoint void (i8*)* @on_frame to i64
  store i64 %t2, i64* %reg_1_ptr
  %t3 = load i8*, i8** %var_counter_ptr
  store i8* %t3, i8** %reg_2_ptr
  %t4 = load i64, i64* %reg_1_ptr
  %t5 = inttoptr i64 %t4 to i8*
  %t6 = inttoptr i64 0 to i8*
  %t7 = load i8*, i8** %reg_2_ptr
  %t8 = call i8* @obo_value_to_str(i8* %t7)
  call void @obo_event_loop_run(i8* %t5, i8* %t6, i8* %t8, i64 30)
