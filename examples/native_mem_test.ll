...
entry:
  ...
  %var_byte_val_ptr = alloca i64
  %var_addr_ptr = alloca i64
  %var_val_ptr = alloca i64
  store i64 4096, i64* %var_addr_ptr
  %t0 = load i64, i64* %var_addr_ptr
  store i64 %t0, i64* %reg_0_ptr
  %t1 = load i64, i64* %reg_0_ptr
  %t2 = inttoptr i64 %t1 to i64*
  store i64 42, i64* %t2
  store i64 0, i64* %reg_1_ptr
  %t3 = load i64, i64* %var_addr_ptr
  ...
  store i64 %t7, i64* %var_val_ptr
  %t8 = load i64, i64* %var_addr_ptr
  ...
  %t13 = trunc i64 255 to i8
  store i8 %t13, i8* %t12
  store i64 0, i64* %reg_6_ptr
  %t14 = load i64, i64* %var_addr_ptr
  ...
  store i64 %t21, i64* %var_byte_val_ptr
  ret void
}
