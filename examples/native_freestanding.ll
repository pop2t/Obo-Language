...
entry:
  ...
  %var_y_ptr = alloca i64
  %var_x_ptr = alloca i64
  store i64 42, i64* %var_x_ptr
  %t0 = load i64, i64* %var_x_ptr
  store i64 %t0, i64* %reg_0_ptr
  %t1 = load i64, i64* %reg_0_ptr
  %t2 = mul i64 %t1, 2
  store i64 %t2, i64* %reg_1_ptr
  %t3 = load i64, i64* %reg_1_ptr
  store i64 %t3, i64* %var_y_ptr
  %t4 = load i64, i64* %var_y_ptr
  store i64 %t4, i64* %reg_2_ptr
  ret void
}

define void @timer_isr() naked noinline {
entry:
  %reg_0_ptr = alloca i64
  %var_n_ptr = alloca i64
  store i64 1, i64* %var_n_ptr
  %t0 = load i64, i64* %var_n_ptr
  store i64 %t0, i64* %reg_0_ptr
  ret void
}

define i32 @add(i64 %arg0, i64 %arg1) {
entry:
  %reg_0_ptr = alloca i64
  %reg_1_ptr = alloca i64
  %reg_2_ptr = alloca i64
