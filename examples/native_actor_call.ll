...
@obo.str.0 = private unnamed_addr constant [2 x i8] c"n\00"
@obo.str.1 = private unnamed_addr constant [7 x i8] c"Pinger\00"
@obo.str.2 = private unnamed_addr constant [6 x i8] c"dummy\00"

define internal i8* @Pinger_make() {
entry:
  %reg_0_ptr = alloca i8*
  %t0 = call i8* @obo_entity_new(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @obo.str.1, i64 0, i64 0))
  call void @obo_entity_put_i64(i8* %t0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @obo.str.2, i64 0, i64 0), i64 0)
  store i8* %t0, i8** %reg_0_ptr
  %t1 = load i8*, i8** %reg_0_ptr
  ret i8* %t1
}

define i64 @Pinger_n(i8* %arg0) {
entry:
  %reg_0_ptr = alloca i8*
...
entry:
  ...
  call void @obo_gc_push_root(i8** %var_p_ptr)
  %t0 = call i8* @Pinger_make()
  store i8* %t0, i8** %reg_0_ptr
  %t1 = load i8*, i8** %reg_0_ptr
  store i8* %t1, i8** %var_p_ptr
  %t2 = load i8*, i8** %var_p_ptr
  store i8* %t2, i8** %reg_1_ptr
  %t3 = load i8*, i8** %reg_1_ptr
  %t4 = call i64 @Pinger_n(i8* %t3)
  store i64 %t4, i64* %reg_2_ptr
  %t5 = load i64, i64* %reg_2_ptr
  call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @obo.fmt.i64, i64 0, i64 0), i64 %t5)
