...
define internal i64 @triple(i64 %arg0) {
entry:
  ...
  store i64 %t0, i64* %var_x_ptr
  %t1 = load i64, i64* %var_x_ptr
...
entry:
  %reg_0_ptr = alloca i64
  %t0 = call i64 @triple(i64 7)
  store i64 %t0, i64* %reg_0_ptr
  %t1 = load i64, i64* %reg_0_ptr
  call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @obo.fmt.i64, i64 0, i64 0), i64 %t1)
