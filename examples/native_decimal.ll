...
@obo.str.0 = private unnamed_addr constant [9 x i8] c"area is \00"
...
entry:
  ...
  %var_area_ptr = alloca double
  %var_pi_ptr = alloca double
  %var_r_ptr = alloca double
  call void @obo_gc_push_root(i8** %reg_10_ptr)
  store double 0x400921F9F01B866E, double* %var_pi_ptr
  store double 0x4014000000000000, double* %var_r_ptr
  %t0 = load double, double* %var_pi_ptr
  store double %t0, double* %reg_0_ptr
  %t1 = load double, double* %var_r_ptr
  store double %t1, double* %reg_1_ptr
  %t2 = load double, double* %reg_0_ptr
  %t3 = load double, double* %reg_1_ptr
  %t4 = fmul double %t2, %t3
  store double %t4, double* %reg_2_ptr
  %t5 = load double, double* %var_r_ptr
  store double %t5, double* %reg_3_ptr
  %t6 = load double, double* %reg_2_ptr
  %t7 = load double, double* %reg_3_ptr
  %t8 = fmul double %t6, %t7
  store double %t8, double* %reg_4_ptr
  %t9 = load double, double* %reg_4_ptr
  store double %t9, double* %var_area_ptr
  %t10 = load double, double* %var_area_ptr
  store double %t10, double* %reg_5_ptr
  %t11 = load double, double* %reg_5_ptr
  call void @obo_print_double(double %t11)
  %t12 = load double, double* %var_pi_ptr
  store double %t12, double* %reg_6_ptr
  %t13 = load double, double* %reg_6_ptr
  %t14 = fadd double %t13, 0x3FF0000000000000
  store double %t14, double* %reg_7_ptr
  %t15 = load double, double* %reg_7_ptr
  call void @obo_print_double(double %t15)
  %t16 = sitofp i64 10 to double
  %t17 = fsub double %t16, 0x4004000000000000
  store double %t17, double* %reg_8_ptr
  %t18 = load double, double* %reg_8_ptr
  call void @obo_print_double(double %t18)
  %t19 = load double, double* %var_area_ptr
  store double %t19, double* %reg_9_ptr
  %t20 = load double, double* %reg_9_ptr
  %t21 = call i8* @obo_f64_to_str(double %t20)
  %t22 = call i8* @obo_str_concat(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @obo.str.0, i64 0, i64 0), i8* %t21)
  store i8* %t22, i8** %reg_10_ptr
  %t23 = load i8*, i8** %reg_10_ptr
  call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @obo.fmt.str, i64 0, i64 0), i8* %t23)
  %t24 = load double, double* %var_pi_ptr
  store double %t24, double* %reg_11_ptr
  %t25 = load double, double* %reg_11_ptr
  %t26 = fsub double 0.0, %t25
  store double %t26, double* %reg_12_ptr
  %t27 = load double, double* %reg_12_ptr
  call void @obo_print_double(double %t27)
  %t28 = load double, double* %var_area_ptr
  store double %t28, double* %reg_13_ptr
  %t29 = load double, double* %reg_13_ptr
  %t30 = fcmp ogt double %t29, 0x4049000000000000
  %t31 = zext i1 %t30 to i64
  store i64 %t31, i64* %reg_14_ptr
  %t32 = load i64, i64* %reg_14_ptr
  call void @obo_print_bool(i64 %t32)
