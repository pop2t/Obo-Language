...
declare i8* @mock_create_device()
declare i64 @mock_destroy_device(i8*)
declare i8* @mock_create_buffer(i8*, i64)
declare i64 @mock_destroy_buffer(i8*)
...
@obo.str.0 = private unnamed_addr constant [26 x i8] c"device and buffer created\00"
@obo.str.1 = private unnamed_addr constant [36 x i8] c"done \E2\80\94 handles released via defer\00"
...
entry:
  ...
  call void @obo_gc_push_root(i8** %var_buf_ptr)
  %t0 = call i8* @mock_create_device()
  ...
  %t4 = call i8* @mock_create_buffer(i8* %t3, i64 4096)
  store i8* %t4, i8** %reg_2_ptr
  %t5 = load i8*, i8** %reg_2_ptr
  store i8* %t5, i8** %var_buf_ptr
  call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @obo.fmt.str, i64 0, i64 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @obo.str.0, i64 0, i64 0))
  %t6 = load i8*, i8** %var_buf_ptr
  store i8* %t6, i8** %reg_3_ptr
  %t7 = load i8*, i8** %reg_3_ptr
  %t8 = call i64 @mock_destroy_buffer(i8* %t7)
  store i64 %t8, i64* %reg_4_ptr
  %t9 = load i8*, i8** %var_dev_ptr
  store i8* %t9, i8** %reg_5_ptr
  %t10 = load i8*, i8** %reg_5_ptr
  %t11 = call i64 @mock_destroy_device(i8* %t10)
  store i64 %t11, i64* %reg_6_ptr
  call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @obo.fmt.str, i64 0, i64 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @obo.str.1, i64 0, i64 0))
